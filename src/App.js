  ...
  const itemData = [
    {
      ...
      time:"117 min",
      text:"Set in a world where fantacy creatures live side by side with humans. A human cop is forced to work with an Orc to find a weapon everyone is prepared to kill for."
