          ...
          {data.map((item, idx) => (
            <ImageListItem
              ...
              sx={{
                ...
                borderRadius: 3,
                boxShadow: "1px 1px 7px rgba(0,0,0,0.8)",
              }}
            >
              <img
                src={item.img}
              ...
              <ImageListItemBar
                style={{
                  ...
                  background:
                    "linear-gradient(90deg, rgba(0,0,0,1) 60%, rgba(251,251,251,0.1) 71%)",
                }}
                position="top"
                title={
                  <Card
                          ...
                          <Stack direction="row" spacing={2}>
                            <Typography
                              style={{
                                ...
                                paddingLeft: 2,
                                paddingRight: 6,
                                boxShadow: "1px 1px 3px rgba(255,255,255,0.7)",
                                borderRadius: 5,
                              }}
                            >
                              {item.time}
